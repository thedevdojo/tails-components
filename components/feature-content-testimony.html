<div class="bg-gray-100">
    <div class="max-w-6xl mx-auto py-8 px-6 md:px-12">
        <div class="md:flex items-center -mx-6 md:-mx-12">
            <div class="w-full md:w-1/2 px-10 mt-16 md:mt-0">
                <div class="bg-white shadow-xl rounded-lg overflow-hidden">
                    <img class="w-full" loading="lazy" src="https://images.unsplash.com/photo-1542103749-8ef59b94f47e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2550&q=80" alt="">
                    <div class="p-12">
                        ...
                        <div class="mt-10">
                            <div>
                                <div class="uppercase text-gray-900 font-semibold tracking-wider">
                                    Irene Sims
                                </div>
            ...
            <div class="w-full md:w-1/2 px-6 md:px-12">
                <h2 class="text-2xl text-gray-900 font-bold">Crafted with Awesomeness</h2>
                <div class="mt-10 flex">
                    <div>
                        <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.879 16.121A3 3 0 1012.015 11L11 14H9c0 .768.293 1.536.879 2.121z"></path></svg>
                    </div>
                    <div class="ml-4 mt-2">
                        <div class="font-semibold text-lg">Radical Feature Set</div>
                ...
                <div class="mt-10 flex">
                    ...
                    <div class="ml-4 mt-2">
                        <div class="font-semibold text-lg">Lightning Fast Speed</div>
                        <p class="mt-2 text-gray-700">
                ...
                <div class="mt-10 flex">
                    ...
                    <div class="ml-4 mt-2">
                        <div class="font-semibold text-lg">Fully Customizable</div>
                        <p class="mt-2 text-gray-700">
