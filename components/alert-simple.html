    ...
    <div class="w-full px-4 py-4 overflow-x-auto text-center whitespace-no-wrap rounded-md">
        <div class="inline-flex w-full max-w-sm ml-3 overflow-hidden bg-white rounded-lg shadow-sm">
            ...
            <div class="px-3 py-2 text-left">
                ...
                <p class="mb-1 text-sm leading-none text-gray-500">A success message</p>
            </div>
        </div>
    </div>
    <div class="w-full px-4 py-4 overflow-x-auto text-center whitespace-no-wrap rounded-md">
        <div class="inline-flex w-full max-w-sm ml-3 overflow-hidden bg-white rounded-lg shadow-sm">
            ...
            <div class="px-4 py-2 text-left">
                ...
                <p class="mb-1 text-sm leading-none text-gray-500">An info message.</p>
            </div>
        </div>
    </div>
    <div class="w-full px-4 py-4 overflow-x-auto text-center whitespace-no-wrap rounded-md">
        <div class="inline-flex w-full max-w-sm ml-3 overflow-hidden bg-white rounded-lg shadow-sm">
            ...
            <div class="px-4 py-2 text-left">
                ...
                <p class="mb-1 text-sm leading-none text-gray-500">A warning message.</p>
            </div>
        </div>
    </div>
    <div class="w-full px-4 py-4 overflow-x-auto text-center whitespace-no-wrap rounded-md">
        <div class="inline-flex w-full max-w-sm ml-3 overflow-hidden bg-white rounded-lg shadow-sm">
            ...
            <div class="px-4 py-2 text-left">
                ...
                <p class="mb-1 text-sm leading-none text-gray-500">An Error message</p>
            </div>
        </div>
    </div>
</div>
